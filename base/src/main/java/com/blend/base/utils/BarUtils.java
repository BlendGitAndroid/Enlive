...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = ApplicationUtil.INSTANCE.getApp().getResources();
    ...
    public static int getActionBarHeight() {
        ...
        if (ApplicationUtil.INSTANCE.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, ApplicationUtil.INSTANCE.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = ApplicationUtil.INSTANCE.getApp().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = ApplicationUtil.INSTANCE.getApp().getResources();
    ...
    public static boolean isNavBarVisible(@NonNull final Window window) {
        ...
        if (isVisible) {
            ...
            if (RomUtils.isSamsung()
                ...
                try {
                    return Settings.Global.getInt(ApplicationUtil.INSTANCE.getApp().getContentResolver(), "navigationbar_hide_bar_enabled") == 0;
    ...
    private static String getResNameById(int id) {
        try {
            return ApplicationUtil.INSTANCE.getApp().getResources().getResourceEntryName(id);
        } catch (Exception ignore) {
            return "";
        }
    }
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) ApplicationUtil.INSTANCE.getApp().getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(ApplicationUtil.INSTANCE.getApp()).hasPermanentMenuKey();
